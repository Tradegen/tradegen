...
contract LeveragedAssetPositionManager is ILeveragedAssetPositionManager {
    ...
    * @param positionIndex Index of the leveraged position in array of leveraged positions
    */
    function closePosition(uint positionIndex) public override {
        //TODO:
    }
    ...
    */
    ...
    event ClosedPosition(address indexed owner, address indexed underlyingAsset, uint collateralRemoved, uint numberOfTokensRepayed, uint interestAccrued, uint timestamp);
