...
interface IBaseUbeswapAdapter {
    ...
    /**
    * @notice Given an input asset address, returns the price of the asset in stablecoin.
    ...
    */
    ...
    /**
    * @notice Returns the farm address and liquidity pool address for each available farm on Ubeswap.
