...
contract BaseUbeswapAdapter is IBaseUbeswapAdapter {
    ...
    */
    function getPrice(address currencyKey) external view override returns(uint) {
        ...
        require(currencyKey != address(0), "BaseUbeswapAdapter: Invalid currency key.");
    ...
    */
    function getAmountsOut(uint numberOfTokens, address currencyKeyIn, address currencyKeyOut) external view override returns (uint) {
        ...
        require(currencyKeyIn != address(0), "BaseUbeswapAdapter: Invalid currencyKeyIn.");
        require(currencyKeyOut != address(0), "BaseUbeswapAdadpter: Invalid currencyKeyOut.");
        ...
        require(numberOfTokens > 0, "BaseUbeswapAdapter: Number of tokens must be greater than 0.");
    ...
    */
    ...
    /**
    * @notice Checks whether the given liquidity pair has a farm on Ubeswap.
    ...
    */
    ...
    /**
    * @notice Returns the decimals of an asset.
    */
