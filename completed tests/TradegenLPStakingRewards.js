...
var contractAddress = "0xA3920204d8557188B6fFF779Ac21515D5eDc0311";
...
{ 
    ...
    it('Initialize', async () => {
        ...
        console.log(data);
        /*
        //Add TradegenLPStakingEscrow contract address to AddressResolver if needed
        let txObject1 = await addressResolverInstance.methods.setContractAddress("TradegenLPStakingEscrow", tradegenLPStakingEscrowAddress);
        let tx1 = await kit.sendTransactionObject(txObject1, { from: account.address }); 
        let receipt1 = await tx1.waitReceipt();
        let data1 = await addressResolverInstance.methods.getContractAddress("TradegenLPStakingEscrow").call();
        console.log(data1);*/
        
        //Transfer 1,000,000 TGEN to TradegenEscrow contract for testing
        let txObject1 = await tradegenInstance.methods.transfer(tradegenLPStakingEscrowAddress, 100000000);
        let tx1 = await kit.sendTransactionObject(txObject1, { from: account.address }); 
        let receipt1 = await tx1.waitReceipt();
        let data1 = await tradegenInstance.methods.balanceOf(tradegenLPStakingEscrowAddress).call();
        console.log(data1);
    ...
    it('Withdraw from first user', async () => {
        ...
        let initialEscrowBalance = await tradegenInstance.methods.balanceOf(tradegenLPStakingEscrowAddress).call();
        ...
        let newEscrowBalance = await tradegenInstance.methods.balanceOf(tradegenLPStakingEscrowAddress).call();
