...
var contractAddress = "0x2665afc2cF7a32550B93beF706dEB27b9A131f71";
var ownerAddress = "0xb10199414D158A264e25A5ec06b463c0cD8457Bb";

function initContract()
{ 
    let instance = new web3.eth.Contract(
        PreviousNPriceUpdates.abi, contractAddress);
    ...
    it('First trading bot state is updated correctly', async () => {
        ...
        assert(
            ...
            'Current value array should have no elements'
        );

        //Update first trading bot indicator state with second value
        let txObject3 = await instance.methods.update(200);
        ...
        assert(
            currentValue2.length == 0,
            'Current value array should have no elements'
        );

        //Update first trading bot indicator state with third value
        let txObject4 = await instance.methods.update(300);
        ...
        assert(
            currentValue3.length == 3,
            'Current value array should have three elements'
        );

        assert(
            currentValue3[0] == 100,
            'First element in current value array should be 100'
        );

        assert(
            currentValue3[1] == 200,
            'Second element in current value array should be 200'
        );

        assert(
            currentValue3[2] == 300,
            'Third element in current value array should be 300'
        );

        //Update first trading bot indicator state with fourth value
        let txObject5 = await instance.methods.update(400);
        ...
        assert(
            currentValue4.length == 3,
            'Current value array should have three elements'
        );

        assert(
            currentValue4[0] == 200,
            'First element in current value array should be 200'
        );

        assert(
            currentValue4[1] == 300,
            'Second element in current value array should be 300'
        );

        assert(
            currentValue4[2] == 400,
            'Third element in current value array should be 400'
        );
    ...
    it('Second trading bot state is updated correctly', async () => {
        ...
        let txObject2 = await instance.methods.update(500);
        let tx2 = await kit.sendTransactionObject(txObject2, { from: account.address });
        ...
        let txObject3 = await instance.methods.update(600);
        let tx3 = await kit.sendTransactionObject(txObject3, { from: account.address });
        ...
        let txObject4 = await instance.methods.update(700);
        let tx4 = await kit.sendTransactionObject(txObject4, { from: account.address });
        ...
        assert(
            currentValue3[0] == 500,
            'First element in current value array should be 500'
        );

        assert(
            currentValue3[1] == 600,
            'Second element in current value array should be 600'
        );

        assert(
            currentValue3[2] == 700,
            'Third element in current value array should be 700'
        );

        //Update second trading bot indicator state with fourth value
        let txObject5 = await instance.methods.update(800);
        let tx5 = await kit.sendTransactionObject(txObject5, { from: account.address });
        ...
        assert(
            currentValue4[0] == 600,
            'First element in current value array should be 600'
        );

        assert(
            currentValue4[1] == 700,
            'Second element in current value array should be 700'
        );

        assert(
            currentValue4[2] == 800,
            'Third element in current value array should be 800'
        );
