...
var contractAddress = "0xeA4d91f31c88eFDcD7fbe001fE54C2308F5f0369";
var ownerAddress = "0xb10199414D158A264e25A5ec06b463c0cD8457Bb";

function initContract()
{ 
    let instance = new web3.eth.Contract(
        SMA.abi, contractAddress);
    ...
    it('First trading bot state is updated correctly', async () => {
        ...
        assert(
            history[2] == 200,
            'Third element in history should be 200'
        );

        assert(
            history[3] == 300,
            'Fourth element in history should be 300'
        );
    });
    ...
    it('Second trading bot state is updated correctly', async () => {
        ...
        assert(
            history[2] == 600,
            'Third element in history should be 600'
        );

        assert(
            history[3] == 700,
            'Fourth element in history should be 700'
        );
    });
}
